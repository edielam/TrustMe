  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="relative overflow-hidden">
          ...
          <div className="bg-gray-900 py-6">
            <nav className="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
              ...
              <div className="hidden md:flex md:items-center md:space-x-6">
                <Link href="/register" className="text-base font-medium text-white hover:text-gray-300">
                  Register
                </Link>
              </div>
            </nav>
        ...
        <main>
  <div className="bg-gray-900 pt-10 pb-16 sm:pt-16 sm:pb-20 lg:pt-8 lg:pb-14 lg:overflow-hidden">
        ...
        <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
          <div className="lg:py-24">
            <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
              ...
              <span className="block text-cyan-400">Login to Your Account</span>
            </h1>
            <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
              Access your account to manage your transactions and settings.
            </p>
          </div>
        </div>
        <div className="mt-12 sm:mt-16 lg:mt-0">
          <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0">
            ...
            <div className="sm:mt-12">
              ...
              <p className="mt-3 text-sm text-gray-300 sm:mt-4">Don&apos;t have an account? <Link href="/register" className="font-medium text-white">Register</Link></p>
            </div>
          </div>
        </div>
      </div>
