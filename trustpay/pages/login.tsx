                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                  <div className="lg:py-24">
                    <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                      ...
                      <span className="block text-teal-400">Login to Your Account</span>
                    </h1>
                ...
                <div className="mt-12 -mb-16 sm:-mb-48 lg:m-0 lg:relative">
                  <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
                    ...
                    <div className="mt-10 sm:mt-12">
                      ...
                      <p className="mt-3 text-sm text-gray-300 sm:mt-4">Don&rsquo;t have an account? <Link href="/register" className="font-medium text-white">Register</Link></p>
                    </div>
                  </div>
                </div>
              </div>
